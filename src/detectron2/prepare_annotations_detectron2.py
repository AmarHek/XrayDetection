...
def preprocess_annotations_coco(image_path, annotations_file, categories, output_file="coco_annotations.csv"):
    ...
    for image_id, annotations in tqdm(grouped_data):
        ...
        coco_format_annotations = vindr_to_coco_format(running_image_id, running_annotation_id,
                                                       class_config, annotations,
                                                       old_shape, new_shape)
...
if __name__ == "__main__":
    categories = [
        {"id": 1, "name": "Aortic enlargement"},
        {"id": 2, "name": "Atelectasis"},
        {"id": 3, "name": "Calcification"},
        {"id": 4, "name": "Cardiomegaly"},
        {"id": 5, "name": "Clavicle fracture"},
        {"id": 6, "name": "Consolidation"},
        {"id": 7, "name": "Edema"},
        {"id": 8, "name": "Emphysema"},
        {"id": 9, "name": "Enlarged PA"},
        {"id": 10, "name": "ILD"},
        {"id": 11, "name": "Infiltration"},
        {"id": 12, "name": "Lung Opacity"},
        {"id": 13, "name": "Lung cavity"},
        {"id": 14, "name": "Lung cyst"},
        {"id": 15, "name": "Mediastinal shift"},
        {"id": 16, "name": "Nodule/Mass"},
        {"id": 17, "name": "Other lesion"},
        {"id": 18, "name": "Pleural effusion"},
        {"id": 19, "name": "Pleural thickening"},
        {"id": 20, "name": "Pneumothorax"},
        {"id": 21, "name": "Pulmonary fibrosis"},
        {"id": 22, "name": "Rib fracture"}
    ]
